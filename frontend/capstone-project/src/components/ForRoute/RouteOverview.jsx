...
function RouteOverview() {
    ...
    // Return statement to return the for route's overview Power BI report.
    return (
        <div>
            <Navbar />
            <PowerBIEmbed
                ...
                embedConfig={{
                    ...
                    embedUrl:
                        "https://app.powerbi.com/reportEmbed?reportId=045203b9-eb2f-4eff-9343-e9d01a150724&groupId=me&reportSection=ReportSectioneb90e3d42d886b6df0b8",
                        ...
                        [
                            ...
                            function () {
                                window.report.setPage(
                                    "ReportSectioneb90e3d42d886b6df0b8"
                                );
